...
@synthesize widgetId, label, icon, type, url, encoding, period, minValue, maxValue, step, refresh, height, isLeaf, iconColor, labelcolor, valuecolor, service, item, linkedPage, text, mappings, delegate, image;
